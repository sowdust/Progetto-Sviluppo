...
public class DBController {
    ...
    */
    ...
    private static final String url = "jdbc:derby://localhost:1527/cryptohelper_db"; 
    private String user;
    private String pwd;
    ...
    public String execute(String query) {
        String out = "";
        Statement st = null; // TODO
        ResultSet rs = null;
        try {
            conn = DriverManager.getConnection(url, "ateam", "ateam"); //ateam è username e password
